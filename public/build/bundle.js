...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			form = element("form");
    			label = element("label");
    			label.textContent = "Cherchez un pokémon :";
    			t1 = space();
    			input = element("input");
    			t2 = space();
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function fetchPokemonBase() {
    		fetch("https://pokeapi.co/api/v2/pokemon?limit=151").then(res => res.json()).then(function (allPoke) {
    			// console.log(allPoke);
    	...
    	function fetchPokemonComplet(pokemon) {
    		...
    		fetch(url).then(res => res.json()).then(function (pokeData) {
    			objetPokemonFull.pic = pokeData.sprites.back_default;

    			fetch(`https://pokeapi.co/api/v2/pokemon-species/${namePokemon}`).then(res => res.json()).then(function (pokeData) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, Content });
    	return [];
    }
